...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //buttons
        val buttonWater = findViewById<Button>(R.id.waterButton)
        val buttonFertilize = findViewById<Button>(R.id.fertilizeButton)
        val buttonSun = findViewById<Button>(R.id.sunButton)
        ...
        buttonWater.setOnClickListener {
            plantImageView.startAnimation(waterAnimation)
            waterPlant()
            updateUI()
        }

        buttonFertilize.setOnClickListener {
            plantImageView.startAnimation(fertilizeAnimation)
            fertilizePlant()
            updateUI()
        }

        buttonSun.setOnClickListener {
            plantImageView.startAnimation(sunAnimation)
            putPlantInSun()
            updateUI()
        }
    }
    ...
    private fun updateUI() {
        val textViewHealth = findViewById<TextView>(R.id.healthTextView)
        val textViewHunger = findViewById<TextView>(R.id.waterTextView)
        val textViewCleanliness = findViewById<TextView>(R.id.sunTextView)
